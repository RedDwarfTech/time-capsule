...
--import-types "crate::model::diesel::tik::tik_schema::*" \
--schema-file "${PROJECT_DIR}"/src/model/diesel/tik/tik_schema.rs --model > "${PROJECT_DIR}"/src/model/diesel/tik/tik_models.rs
